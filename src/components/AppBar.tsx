...
export const AppBar: FC = (props) => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-black text-pink">
        <div className="navbar-start text-pink">
          ...
          <div className="text-2xl font-bold text-pink">FORTUNE</div>
        </div>
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            ...
            <Link href="/wallet">
              <a className="btn btn-ghost btn-sm rounded-btn">Wallet</a>
            </Link>
            <Link href="/trade">
