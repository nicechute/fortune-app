...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className={`bg-black max-w-sm w-full bg-bkg-1 shadow-lg rounded-md mt-2 pointer-events-auto ring-1 ring-black ring-opacity-5 p-2 mx-4 mb-12 overflow-hidden`}
    >
      <div className={`p-4`}>
